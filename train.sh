MAX_UPDATE=600000 # 200000
WARMUP=30000
# DECAY_STEP=200000
INTERVAL=500 # 625 or 10000
...
DATABINS=$(python third_party/get_databin_list.py --start 1 --end 4 --data_path $DATA_PATH)
echo $DATABINS
# mkdir -p /srv/local2/shijie/checkpoints/$CODENAME

CUDA_VISIBLE_DEVICES=0,1 fairseq-train $DATABINS \
--save-dir ${STORE_PATH} \
